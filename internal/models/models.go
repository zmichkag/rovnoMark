...
// ScannerConfig описывает подключение сканера и его место в топологии линии.
...
// ScannerRead хранит успешное чтение, полученное от сканера.
...
type TaskCode struct {
	...
	Status       string    `json:"status"`        // 'pending', 'in_buffer', 'printed', 'verified'
